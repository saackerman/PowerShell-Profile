<#
	...
	.EXAMPLE
        ...
        icm -ComputerName ($servers.name) -FilePath .\get-inventoryV3.ps1
...
$smtp = "smtp.csaa.com"
#$to = "PlatformReports@aaagateway.csaa.com" #http://aaagateway/it/platform/PlatformReports/Forms/AllItems.aspx
$to = "sean.ackerman@csaa.com"
